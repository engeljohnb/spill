;(load "~/Desktop/Programming/bio_game/gui_config/button-config.lisp")
;(load "~/Desktop/Programming/bio_game/gui_config/input-config.lisp")
;(load "~/Desktop/Programming/bio_game/gui_config/typing-bar-config.lisp")
(in-package :spill)
